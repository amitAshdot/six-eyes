...
import chatbox from '../../../images/chatbox.webp'
    ...
    return (
        <section className='customers-section'>
            ...
            <div className="customers-container">
                <div className="customers__item col-1-of-4">
                ...
                <div className="customers__item col-1-of-4">
                    <a href="chatbox.check-box.co.il/" target="_blank" rel="noopener noreferrer" className="customers__item__btn btn">
                        <img src={chatbox} alt="איוונטדו" className="customers__item__image" />
                        <h2>צ׳ק בוקס</h2>
                        <p className='customers__item__text'>מחשבון להשוות מחירי אתרים יחד עם העזרה של צאט גיפיטי</p>
                    </a>
                </div>
            </div>
        </section>
